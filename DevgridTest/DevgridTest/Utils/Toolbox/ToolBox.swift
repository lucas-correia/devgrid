...
final class ToolBox: NSObject{
    ...
    class func classVersionInfo() -> String!{
        ...
        //return "Version: 0.3.0  |  Date: 30/03/2017  |  Autor: Lucas  |  Note: Inclusão do grupo 'GRAPHIC'. Mescla do grupo 'CONVERTER', feito pelo Lucas.";
        //return "Version: 0.3.1  |  Date: 04/04/2017  |  Autor: EricoGT  |  Note: Correções e adequações para swift.";
        //return "Version: 0.4.0  |  Date: 05/04/2017  |  Autor: Lucas  |  Note: Inclusão de métodos no grupo messureHelper.";
        ...
        //return "Version: 0.5.1  |  Date: 31/05/2017  |  Autor: Lucas  |  Note: Correções em métodos do grupo 'date'.";
        //return "Version: 0.6.0  |  Date: 31/10/2017  |  Autor: EricoGT  |  Note: Agrupamento de métodos em sub-classes.";
        //return "Version: 0.7.0  |  Date: 04/12/2017  |  Autor: Lucas  |  Note: Novo grupo adicionado 'Text', para tratamento de máscaras.";
        //return "Version: 0.7.1  |  Date: 04/01/2018  |  Autor: Lucas  |  Note: Fix nas extensions da classe.";
        //return "Version: 0.7.2  |  Date: 23/01/2018  |  Autor: EricoGT  |  Note: Novas extensions para String e NSAttributedString.";
        //return "Version: 0.8.0  |  Date: 20/02/2018  |  Autor: Lucas  |  Note: A classe ToolBoxText teve os métodos de máscara atualizados.";
        //return "Version: 0.9.0  |  Date: 10/04/2018  |  Autor: EricoGT  |  Note: Inclusão de novos modelos de dispositivos (deviceModels).";
        //
        return "Version: 0.10.0  |  Date: 05/12/2018  |  Autor: Lucas  |  Note: Atualização dos métodos de Imagem para nova versão do Swift.";
    }
...
class ToolBoxGraphic{
    ...
    class func normalizeImage(image:UIImage, maximumDimension:CGFloat, quality:Float) -> UIImage{
        ...
        let iData:Data = image.jpegData(compressionQuality: CGFloat(qualityI))!
